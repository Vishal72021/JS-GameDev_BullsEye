  ...
  class Player {
    ...
    update() {
      ...
      this.game.obstacles.forEach((obstacle) => {
        ...
        if (collision) {
          this.unitX = dx / distance;
          this.unitY = dy / distance;
          this.collisionX = obstacle.collisionX + (sumOfRadii + 1) * this.unitX;
          this.collisionY = obstacle.collisionY + (sumOfRadii + 1) * this.unitY;
        }
      });
    }
  }
  ...
  class Egg {
    ...
    update(deltaTime) {
      ...
      collisionObjects.forEach((collisionObject) => {
        let [collision, distance, sumOfRadii, dx, dy] =
          this.game.checkCollision(this, collisionObject);

        if (collision) {
          this.unitX = dx / distance;
          this.unitY = dy / distance;
          this.collisionX =
            collisionObject.collisionX + (sumOfRadii + 1) * this.unitX;
          this.collisionY =
            collisionObject.collisionY + (sumOfRadii + 1) * this.unitY;
        }
      });
